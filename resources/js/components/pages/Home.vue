<template>
    <div>
            ...
            <div id="wrapper">
                <div class="slider-wrapper">
                    <div id="mainSlider" class="nivoSlider">
                        <img
                            src="assets/img/slider/home2/1.jpg"
                            alt="main slider"
                            title="#htmlcaption"
                        />
                        <img
                            src="assets/img/slider/home2/2.jpg"
                            alt="main slider"
                            title="#htmlcaption2"
                        />
                    </div>
                        ...
                        <div class="container">
                            <div class="slider-left slider-right">
                                ...
                                <div class="animated slider-btn fadeInUpBig">
                                    <a class="shop-btn" href="shop.html"
                                        >Shop now</a
                                    >
                                </div>
                            </div>
                    ...
                    >
                        <div class="container">
                            <div
                                class="slider-left two-caption-text slider-right"
                            >
                                <div class="slide-text animated zoomInUp">
                                    <h3>new collection</h3>
                                    <h1>Men’s Fashion 2016</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="colect-text ">
                            ...
                            <a href="javascript:;"
                                >Shop Now <i class="mdi mdi-arrow-right"></i
                            ></a>
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="colect-text ">
                            <h4>
                                <a href="javascript:;">Men’s Collection 2016</a>
                            </h4>
                            <p>
                    ...
                    <ul class="load-list load-list-one">
                        <li>
                            <div class="row text-center">
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <a href="javascript:;"
                                                ><img
                                                    src="assets/img/products/16.jpg"
                                                    alt="Product Title"
                                            /></a>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <a href="javascript:;"
                                                ><img
                                                    src="assets/img/products/17.jpg"
                                                    alt="Product Title"
                                            /></a>
                                            <div class="actions-btn">
                                                <a href="javascript:;"
                                ...
                                <!-- single product end -->
                                <div
                                    class="col-xs-12 col-sm-6 col-md-3 r-margin-top"
                                >
                                    <div class="single-product">
                                        <div class="product-img">
                                            <div class="pro-type">
                                            ...
                                            <a href="javascript:;"
                                                ><img
                                                    src="assets/img/products/18.jpg"
                                                    alt="Product Title"
                                            /></a>
                                            <div class="actions-btn">
                                                <a href="javascript:;"
                                ...
                                >
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="javascript:;"
                                                ><img
                                                    src="assets/img/products/19.jpg"
                                                    alt="Product Title"
                                            /></a>
                                            <div class="actions-btn">
                                                <a href="javascript:;"
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="javascript:;"
                                                ><img
                                                    src="assets/img/products/21.jpg"
                                                    alt="Product Title"
                                            /></a>
                                            <div class="actions-btn">
                                                <a href="javascript:;"
                                ...
                                >
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <a href="javascript:;"
                                                ><img
                                                    src="assets/img/products/22.jpg"
                                                    alt="Product Title"
                                            /></a>
                                            <div class="actions-btn">
                                                <a href="javascript:;"
                                ...
                                >
                                    <div class="single-product">
                                        <div class="product-img">
                                            <a href="javascript:;"
                                                ><img
                                                    src="assets/img/products/23.jpg"
                                                    alt="Product Title"
                                            /></a>
                                            <div class="actions-btn">
                                                <a href="javascript:;"
                            ...
                            <div class="tab-pane fade in active" id="dress1">
                                ...
                                <div class="count-text clearfix">
                                    <ul id="countdown-1">
                                        <li>
                                            <p
                                                class="timeRefDays timedescription"
                                            >
                                                days
                                            </p>
                                            <span class="days timenumbers"
                                                >00</span
                                            >
                                        </li>
                                        <li>
                                            <p
                                                class="timeRefHours timedescription"
                                            >
                                                hrs
                                            </p>
                                            <span class="hours timenumbers"
                                                >00</span
                                            >
                                        </li>
                                        <li>
                                            <p
                                                class="timeRefMinutes timedescription"
                                            >
                                                mins
                                            </p>
                                            <span class="minutes timenumbers"
                                                >00</span
                                            >
                                        </li>
                                        <li>
                                            <p
                                                class="timeRefSeconds timedescription"
                                            >
                                                secs
                                            </p>
                                            <span class="seconds timenumbers"
                                                >00</span
                                            >
                                        </li>
                                    </ul>
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="padding">
                            <div class="tab-content">
                                <div
                                    class="single-coming tab-pane fade in active"
                                    id="text1"
                                >
                                    <h4>
                                        <a href="javascript:;"
                                            >The Maker usc Dress</a
                                        >
                                    </h4>
                                    <span
                                    ...
                                    <ul class="color-size">
                                        ...
                                        <li>
                                            ...
                                            ><a href="javascript:;">Grean</a
                                            ><a href="javascript:;">Blue</a>
                                        </li>
                                        <li>
                                            <span>Brand</span
                                            ><strong>:</strong>Crazy Fashion
                                        </li>
                                        <li>
                                            <span>category</span
                                            ><strong>:</strong>Fashion Men’s
                                        </li>
                                    </ul>
                                </div>
                                <div
                                    class="single-coming tab-pane fade"
                                    id="text2"
                                >
                                    <h4>
                                        <a href="javascript:;"
        ...
        <div
            class="tab-products single-products products-two section-padding extra-padding-top"
        >
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            ...
                                            >
                                                <div class="quick-image">
                                                    <div
                                                        class="single-quick-image text-center"
                                                    >
                                                        <div class="list-img">
                                                            <div
                                                                class="product-img tab-content"
                                                            >
                                                                <div
                                                                ...
                                                                >
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        href="javascript:;"
                                                                        ><img
                                                                            src="assets/img/products/z1.jpg"
                                                                            alt=""
                                                                ...
                                                                >
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        href="javascript:;"
                                                                        ><img
                                                                            src="assets/img/products/z2.jpg"
                                                                            alt=""
                                                                            class="simpleLens-big-image"
                                                                    /></a>
                                                                </div>
                                                                ...
                                                                >
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        href="javascript:;"
                                                                        ><img
                                                                            src="assets/img/products/z3.jpg"
                                                                            alt=""
                                                                            class="simpleLens-big-image"
                                                                    /></a>
                                                                </div>
                                                                ...
                                                                >
                                                                    ...
                                                                    <a
                                                                        ...
                                                                        href="javascript:;"
                                                                        ><img
                                                                            src="assets/img/products/z4.jpg"
                                                                            alt=""
                                                                            class="simpleLens-big-image"
                                                                    /></a>
                                                                </div>
                                                    ...
                                                    <div class="quick-thumb">
                                                        ...
                                                        >
                                                            <li>
                                                                ...
                                                                >
                                                                    <img
                                                                        src="assets/img/products/s1.jpg"
                                                                        alt="quick view"
                                                                    />
                                                                </a>
                                                            </li>
                                                            <li class="active">
                                                                ...
                                                                >
                                                                    <img
                                                                        src="assets/img/products/s2.jpg"
                                                                        alt="small image"
                                                                    />
                                                                </a>
                                                            </li>
                                                            <li>
                                                                ...
                                                                >
                                                                    <img
                                                                        src="assets/img/products/s3.jpg"
                                                                        alt="small image"
                                                                    />
                                                                </a>
                                                            </li>
                                            ...
                                            >
                                                <div class="quick-right">
                                                    <div class="list-text">
                                                        ...
                                                        <div
                                                            class="share-tag clearfix"
                                                        >
                                                            <ul
                                                                class="blog-share floatleft"
                                                            >
                                                                <li>
                                                                    <h5>
                                                                        share
